...
public:
        ...
        : it_(nh_)
    {
        ...
        image_sub_ = it_.subscribe("/rgb_image", 1, &ImageConverter::imageCb, this);
        image_pub_ = it_.advertise("/image_process/circle_detection", 1);
    ...
    void imageCb(const sensor_msgs::ImageConstPtr& msg)
    {
        ...
        cout << minC;
            ...
            int posX = center.x - 240;
            int posY = center.y - 160;
