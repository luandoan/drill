...
if("TRUE" STREQUAL "TRUE")
  set(detect_SOURCE_PREFIX /home/luan/drill/src/detect)
  set(detect_DEVEL_PREFIX /home/luan/drill/devel)
  set(detect_INSTALL_PREFIX "")
  set(detect_PREFIX ${detect_DEVEL_PREFIX})
else()
  set(detect_SOURCE_PREFIX "")
  set(detect_DEVEL_PREFIX "")
  set(detect_INSTALL_PREFIX /home/luan/drill/install)
...
if(NOT "/home/luan/drill/devel/include " STREQUAL " ")
  set(detect_INCLUDE_DIRS "")
  set(_include_dirs "/home/luan/drill/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'detect' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'luan <luan@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'detect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/luan/drill/src/detect/${idir}'.  Ask the maintainer 'luan <luan@todo.todo>' to fix it.")
    endif()
...
set(detect_EXPORTED_TARGETS "detect_generate_messages_cpp;detect_generate_messages_lisp;detect_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${detect_dep}_FOUND)
      find_package(${detect_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${detect_dep} REQUIRED ${depend_list})
  endif()
